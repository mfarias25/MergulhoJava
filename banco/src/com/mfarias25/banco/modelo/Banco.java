...
public class Banco {
    ...
    public Banco() {
        Pessoa pessoa1 = new Pessoa("Mateus Farias", "10203040501");
        Pessoa pessoa2 = new Pessoa("Jaqueline Farias", "60708090101");
    ...
    public Optional<Conta> buscar (int agencia, int numeroConta) {
        for (Conta conta : getContas()) {
            if (conta
                    .getAgencia() == agencia && conta
                    .getNumero() == numeroConta){
